...
export const ThreeCamera = defineComponent({ resourceId: Types.ui32, fov: Types.f32, near: Types.f32, far: Types.f32, isActive: Types.ui8 });
...
export const ThreeRenderer = defineComponent({ resourceId: Types.ui32 });
